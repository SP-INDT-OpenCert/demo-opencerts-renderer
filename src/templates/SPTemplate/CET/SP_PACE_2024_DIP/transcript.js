...
class Template extends Component {
  ...
  render() {
        ...
        <>
          <div className="container">
            <div className="row" style={{ marginRight: "10px" }}>
              ...
              <div className="col"></div>
              <div className="col"></div>
              <div className="col my-5 justify-content-centre">
                <img src={IMG_CERT_SPLOGO} alt="SP Logo" width="200" height="65" />
              </div>
            </div>
            ...
            <div className="row h4 my-4" style={{ fontSize: "18px", fontFamily: "Calibri" }}>
              <div className="col font-weight-bold text-lg-center">ACADEMIC TRANSCRIPT</div>
            </div>
          </div>
              ...
              <div className="col-10">
                <div>
                  <div className="row" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
                    ...
                    <div className="col-7" style={{ textTransform: "uppercase" }}>
                      <b>{p_Cert.recipient.name}</b>
                    </div>
                  </div>
                  <div className="row" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
                    <div className="col-2" style={{ minWidth: 140 }}>
                    ...
                    <div className="col-7">
                      <b>{p_Cert.recipient.studentId}</b>
                    </div>
                  </div>
                  <div className="row" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
                    <div className="col-2" style={{ minWidth: 140 }}>
                  ...
                  <div className="row" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
                    ...
                    <div className="col-7">
                      <b>{get(document, "transcript[0].cumGPA")}</b>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="row" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
          ...
          <div className="col-3">
            <div className="text-left">
              <b>{document.additionalData.transcriptSignatories[0].position} </b>
            </div>
            <div className="text-left">
              <b>Professional & Adult Continuing</b>
            </div>
            <div className="text-left">
              <b>Education (PACE) Academy</b>
            </div>
          </div>
          <div className="col-1" />
        </div>
            ...
            <table>
              <tbody className="align-top">
                <tr>
                  ...
                  <th width="25px" className="text-center">
                    &nbsp;&nbsp;&nbsp;
                  </th>
                  <th width="200px">
                    <u>GRADE DESCRIPTION</u>
                  </th>
            ...
            <table>
              <tbody className="align-top">
                <tr>
                  ...
                  <td width="25px" className="text-center">
                    &nbsp;&nbsp;&nbsp;
                  </td>
                  <th width="200px">
                    <u>GRADE DESCRIPTION</u>
    ...
    const renderTermTranscript = (p_ObjTranscript, iSn) => {
      ...
      const dispOthItems = objOthItems
        ? objOthItems.map((objItem, i) => (
      ...
      const renderModules = objModules.map((objMod, i) => <div key={i}>{renderEachModule(objMod, i)}</div>);
      return (
        <div>
          <div className="row" style={{ height: "25px" }}></div>
          <div className="row">
            <div className="col-9" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
              {get(p_ObjTranscript, "name")}{" "}
            </div>
          </div>
    ...
    const renderTranscripts = transcriptData.map((objTerm, i) => (
      <div className="col-12" key={i}>
        <div className="row">
          <div className="col-1" />
          <div className="col-10">{renderTermTranscript(objTerm, i)}</div>
        </div>
      </div>
    ));

    return document.additionalData.TranscriptExists ? (
      <div className="container">
        <HideTranscriptBanner hideTranscript={() => handleObfuscation("transcript")} />
        <div
          className="container"
          style={{
            maxWidth: "1100px",
        ...
        >
          <div className="row">{renderHeader(document)}</div>
          ...
          <div className="row" style={{ fontSize: "15px", fontFamily: "Calibri" }}>
            ...
            <div className="col text-center">
              <b>End of Academic Transcript</b>
            </div>
            <div className="col-3"></div>
          </div>
          <div className="row" style={{ height: "50px" }}></div>
          <div className="row">{renderFooter(document)}</div>
        </div>
      </div>
    ) : null;
  }
