...
const Template = ({ document }) => {
  const addOnDisp = get(document, "additionalData.diplomaAddOn").map((txtArr, i) => (
    <div
      ...
      style={{ fontFamily: "Times", fontVariant: "small-caps", fontSize: "37px" }}
    >
      {txtArr}
    </div>
  ));
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontFamily: "Gill Sans,Gill Sans MT,Calibri,sans-serif", fontSize: "21px", textAlign: "center" }}
      >
      ...
      <div
        ...
        style={{ fontFamily: "Gill Sans,Gill Sans MT,Calibri,sans-serif", fontSize: "24px", textAlign: "center" }}
      >
        <b>Certificate</b>
      </div>
      {/*{addOnDisp} */}
      ...
      <div
        ...
        style={{ fontFamily: "Gill Sans,Gill Sans MT,Calibri,sans-serif", fontSize: "24px", textAlign: "center" }}
      >
        <b>{document.additionalData.ModulerCertDescr}</b>
      </div>
      <div
        className="mt-2 d-flex justify-content-center"
        style={{ fontFamily: "Gill Sans,Gill Sans MT,Calibri,sans-serif", fontSize: "21px", textAlign: "center" }}
      ...
      <div className="row">
        ...
        <div className="col-4 mt-2 d-flex flex-column">
          ...
          <div className="text-center">
            <img src={IMG_CERT_PACELOGO} alt="Seal" style={{ width: "250px", marginTop: "-15px" }} />
          </div>
        </div>
      </div>
      ...
      <div className="row">
        ...
        <div className="col my-5 ml-3 d-flex" style={{ fontFamily: "Times", fontSize: "13px" }}>
          {document.recipient.studentId}/{document.additionalData.CertNumber}
        </div>
      </div>
    </div>
  );
